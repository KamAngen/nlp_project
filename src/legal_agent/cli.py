...
def build_parser() -> argparse.ArgumentParser:
    ...
    build_study_kb.add_argument("--question-count", type=int, default=180)
    build_study_kb.add_argument("--case-count", type=int, default=96)
    ...
    prepare_study_data.add_argument("--question-count", type=int, default=180)
    prepare_study_data.add_argument("--case-count", type=int, default=96)
